...
class LinearGrayscaleToAsciiPixelConverterTest extends FunSuite {
  ...
  test("convert should throw exception when conversion table is empty", StandardTestsGroup) {
  ...
  test("Boundary value: Extreme low grayscale (0) maps to '@'", StandardTestsGroup) {
  ...
  for (i <- 0 until conversionTable.length - 2) {
    ...
    val upperBound = (rangePerChar * (i + 1)).toInt - 1


    test(s"Lower boundary value: Grayscale $lowerBound maps to ${conversionTable.charAt(i)}", StandardTestsGroup) {
    ...
    test(s"Upper boundary value: Grayscale just below $upperBound maps to ${conversionTable.charAt(i)}", StandardTestsGroup) {
  ...
  test("Class 1: Grayscale 0-11 maps to '@'", StandardTestsGroup) {
  ...
  test("Class 2: Grayscale 12-23 maps to 'B'", StandardTestsGroup) {
  ...
  test("Class 3: Grayscale 24-35 maps to '%'", StandardTestsGroup) {
  ...
  test("Class 4: Grayscale 36-47 maps to '8'", StandardTestsGroup) {
  ...
  test("Class 5: Grayscale 48-59 maps to 'W'", StandardTestsGroup) {
  ...
  test("Class 6: Grayscale 60-71 maps to '#'", StandardTestsGroup) {
  ...
  test("Class 7: Grayscale 72-83 maps to '*'", StandardTestsGroup) {
  ...
  test("Class 8: Grayscale 84-95 maps to 'o'", StandardTestsGroup) {
  ...
  test("Class 9: Grayscale 96-107 maps to 'a'", StandardTestsGroup) {
  ...
  test("Class 10: Grayscale 108-119 maps to 'h'", StandardTestsGroup) {
  ...
  test("Class 11: Grayscale 120-131 maps to 'k'", StandardTestsGroup) {
  ...
  test("Class 12: Grayscale 132-143 maps to 'b'", StandardTestsGroup) {
  ...
  test("Class 13: Grayscale 144-155 maps correctly", StandardTestsGroup) {
    val grayscaleValue = 149 // Midpoint of the range 144-155
    val result = converter.convert(RGBPixel(grayscaleValue, grayscaleValue, grayscaleValue))
    assert(result == Right(AsciiPixel('p')))
  }

  // Class 14: Grayscale values from 156 to 167
  test("Class 14: Grayscale 156-167 maps correctly", StandardTestsGroup) {
  ...
  test("Class 15: Grayscale 168-179 maps correctly", StandardTestsGroup) {
    val grayscaleValue = 173 // Midpoint of the range 168-179
    val result = converter.convert(RGBPixel(grayscaleValue, grayscaleValue, grayscaleValue))
    assert(result == Right(AsciiPixel('m')))
  }

  // Class 16: Grayscale values from 180 to 191
  test("Class 16: Grayscale 180-191 maps correctly", StandardTestsGroup) {
    val grayscaleValue = 185 // Midpoint of the range 180-191
    val result = converter.convert(RGBPixel(grayscaleValue, grayscaleValue, grayscaleValue))
    assert(result == Right(AsciiPixel('q')))
  }

  // Class 17: Grayscale values from 192 to 203
  test("Class 17: Grayscale 192-203 maps correctly", StandardTestsGroup) {
  ...
  test("Class 18: Grayscale 204-215 maps correctly", StandardTestsGroup) {
  ...
  test("Class 19: Grayscale 216-227 maps correctly", StandardTestsGroup) {
  ...
  test("Class 20: Grayscale 228-239 maps correctly", StandardTestsGroup) {
  ...
  test("Class 21: Grayscale 240-251 maps correctly", StandardTestsGroup) {
    val grayscaleValue = 245 // Midpoint of the range 240-251
    val result = converter.convert(RGBPixel(grayscaleValue, grayscaleValue, grayscaleValue))
    assert(result == Right(AsciiPixel('0')))
  }

  // Class 22: Grayscale values from 252 to 255
  test("Class 22: Grayscale 252-255 maps correctly", StandardTestsGroup) {
    val grayscaleValue = 253 // Midpoint of the range 252-255
    val result = converter.convert(RGBPixel(grayscaleValue, grayscaleValue, grayscaleValue))
    assert(result == Right(AsciiPixel('Q'))) // Adjusted based on your feedback
  }

  test("Class 23: Should throw exception", StandardTestsGroup) {
    val grayscaleValue = 270
    try {
      val result = converter.convert(RGBPixel(grayscaleValue, grayscaleValue, grayscaleValue))
