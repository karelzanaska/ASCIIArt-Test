...
class NonLinearGrayscaleToAsciiPixelConvertorTest extends FunSuite {
  ...
  test("convert should correctly convert RGBPixel to AsciiPixel when grayscale value is less than 150", StandardTestsGroup) {
  ...
  test("convert should correctly convert RGBPixel to AsciiPixel when grayscale value is greater than or equal 150", StandardTestsGroup) {
