...
class GrayscaleToAsciiImageConverterTest extends FunSuite {
  ...
  test("convert should correctly convert RGBImage to AsciiImage when input is valid", StandardTestsGroup) {
  ...
  test("convert should return error when input is not valid", StandardTestsGroup) {
  ...
  test("convert should correctly handle extreme low grayscale value", StandardTestsGroup) {
